...
contract KIP17Full is KIP17, KIP17Enumerable, KIP17Metadata {
    constructor (string memory name, string memory symbol, uint256 expireDay, uint256 stampCount) public KIP17Metadata(name, symbol) KIP17Enumerable(expireDay, stampCount) {
